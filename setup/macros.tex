...
%%  description: Macros for the RoboCupAtHome Network Specifications
%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% rubber: setlist arguments --shell-escape

\newcommand{\netspecVersion}{\STATE\ version for RoboCup \YEAR\xspace(\VERSION)}
...
\def\revnumtmpfile{.temp_netspec_version}
\def\revdattmpfile{.temp_netspec_date}
